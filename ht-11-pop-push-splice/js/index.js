...
function f11() {
  ...
  document.querySelector('.out-11').textContent = d11.indexOf(i_11);
}
...
function f18() {
  ...
  document.querySelector('.out-18').textContent = d18.includes(i_18);
}
...
let maxString = '';
function f19() {
  for(let el = 0; el < d19.length; el++){
    if(d19[el].length > maxString.length){
      maxString = d19[el];
    }
  }
